            ...
            <div className="col-span-4">
              ...
              <div>
                ...
                <p>
                  ...
                  designed to assist the morbidly obese in developing a
                  healthier lifestyle. A surgical weight loss operation is a
                  useful tool for weight loss, but it is a surgical procedure
                  that requires a substantial lifelong commitment. The surgery
                  alone will not help someone lose weight and keep it off. The
                  patient must change eating and exercise habits. Without
                  changes to the daily pattern of eating and activity, the
                  patient is likely to regain weight over time. You’ll need to
                  attend educational classes and support groups to work on
                  developing new, lifelong healthy habits and behaviours. Above
                  all, you’ll need to maintain a commitment to reach and
                  maintain a weight that keeps you healthy.
                </p>
                {/* 2 */}
                ...
                <p>
                  ...
                  loss, some of which reduce the functioning size of the stomach
                  and others that bypass parts of the digestive tract, reducing
                  the absorption of calories and nutrients. Different types of
                ...
                <p>
                  ...
                  but a necessary option. Unfortunately, many obese people
                  suffer discrimination and unwarranted scrutiny and judgment
                ...
                <p>
                  ...
                  death. But a number of recent advances have helped to minimize
                  risks. Surgeries performed at the Asian Institute of
                  Gastroenterology are done laparoscopically with mini-incisions
                  that result in faster healing, less pain, and less scarring.
                  In addition, having the procedure may assist patients in
                  overcoming otherwise life-threatening conditions associated
                  with obesity, including Type II diabetes, hypertension, high
                ...
                <p>
                  ...
                  operations because the procedure inhibits the proper
                ...
                <p>
                  ...
                  team member. Team members work to help patients make long-term
                  lifestyle changes.
                </p>
                {/* 7 */}
                <h3 className="text-theme">
                ...
                <p>
                  ...
                  However, it’s not just based on weight alone but on what other
                  medical conditions you also have, such as diabetes.
                </p>
                <p>BMI {">"}35 kg/m2 with or without comorbidities</p>
                <p>BMI {">"}32 kg/m2 with comorbidities</p>
                <p>
                  BMI {">"}30 kg/m2 with central obesity WS {">"}80cm (females)
                  WS {">"}90 cm (males) with at least two criteria of metabolic
                  syndrome
                </p>
