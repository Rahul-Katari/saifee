      ...
      <div className="p-6 lg:px-8">
        <div className="mx-auto md:grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-5">
          <img
            ...
            className="lg:col-span-2 md:my-24 md:ps-8 rounded-lg"
          />
          <div className="lg:pr-8 pt-4 lg:col-span-3">
            <div>
              <h2 className="text-base font-medium leading-7 text-grey text-xl">
                Welcome
              </h2>
              <p className="mt-1 md:text-4xl tracking-tight text-theme text-2xl">
                {title}
              </p>
